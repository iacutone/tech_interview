defmodule TechInterviewWeb.QuestionControllerTest do
  use TechInterviewWeb.ConnCase

  alias TechInterview.Questions

  @create_attrs %{code: "some code", company_id: 42, language: "some language", user_id: 42}
